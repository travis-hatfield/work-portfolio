      ...
      <section className="bg-noise-fade -mx-6 -mt-8 rounded-b-3xl px-6 pb-14 pt-14 sm:-mx-8 sm:px-8">
        ...
        <div className="mt-8 flex flex-wrap items-center gap-3">
          <a
            ...
            className="rounded-full bg-accent px-5 py-2.5 text-sm font-medium text-white transition-transform hover:-translate-y-0.5 hover:shadow-lg"
          >
            Download resume ↓
          </a>
          <a
        ...
        <div className="mt-4 divide-y divide-border border-y border-border">
          {professionalLinks.map((l) => (
            <Link
              key={l.href}
              href={l.href}
              className="group grid grid-cols-[3rem_1fr_auto] items-center gap-4 py-6 transition-colors hover:bg-accent-soft/50 sm:grid-cols-[3.5rem_1fr_auto]"
            >
